...
namespace RusticsInventoryMVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,Description,CreateDate,ModifyDate,HowTo,Price,Weight,Size,CategoryID,AmountOnHand")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,Description,CreateDate,ModifyDate,HowTo,Price,Weight,Size,CategoryID,AmountOnHand")] Product product)
        {
            if (ModelState.IsValid)
            {
